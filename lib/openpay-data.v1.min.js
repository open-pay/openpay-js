...
r.src=e,r.width=1,r.height=1,n.appendChild(r)}},50)}function o(){var o,r="?m="+(OpenPay.sandboxMode?n._sandboxCollectorId:n._collectorId)+"&s="+encodeURIComponent(t())
...
n._hostname="https://api.openpay.mx/",n._sandboxHostname="https://sandbox-api.openpay.mx/",n._developHostname="https://dev-api.openpay.mx/",n._collectorIframe="logo.htm",n._collectorImg="logo.gif",n._collectorId=203e3,n._sandboxCollectorId=203e3,n._deviceDataId=void 0,n.setup=function(e,n){if(e){var r=document.getElementById(e).appendChild(document.createElement("input"))
r.type="hidden",r.value=t(),r.name=n?n:"deviceDataId",r.id=n?n:"deviceDataId"}return o()},OpenPay.deviceData=n
...
var o,n,i,s,a=this._key[e],h=t[0]^a[0],c=t[e?3:1]^a[1],l=t[2]^a[2],d=t[e?1:3]^a[3],_=a.length/4-2,u=4,f=[0,0,0,0],p=this._tables[e],m=p[0],g=p[1],y=p[2],v=p[3],E=p[4]
for(s=0;_>s;s++)o=m[h>>>24]^g[c>>16&255]^y[l>>8&255]^v[255&d]^a[u],n=m[c>>>24]^g[l>>16&255]^y[d>>8&255]^v[255&h]^a[u+1],i=m[l>>>24]^g[d>>16&255]^y[h>>8&255]^v[255&c]^a[u+2],d=m[d>>>24]^g[h>>16&255]^y[c>>8&255]^v[255&l]^a[u+3],u+=4,h=o,c=n,l=i
