...
this.OpenPay=function(){function e(){}return e.version=1,e.sandboxMode=!1,e.hostname="https://api.openpay.mx/v1/",e.sandboxHostname="https://sandbox-api.openpay.mx/v1/",e.customerId="",e.setSandboxMode=function(t){e.sandboxMode=t?!0:!1},e.getSandboxMode=function(){return e.sandboxMode},e.setId=function(t){e.id=t},e.setApiKey=function(t){e.key=t},e.setCustomerId=function(t){e.customerId=t},e.log=function(e){"object"==typeof e&&"toString"in e&&(e=""+e),"undefined"!=typeof console&&"log"in console&&console.log(e)},e.validate=function(e,t){if(!e)throw t+" required"
...
if(""!==e.customerId&&!/^[a-z0-9]+$/i.test(e.customerId))return u("Invalid OpenPay Customer ID"),void 0
...
m=i(e.key),p=(e.sandboxMode?e.sandboxHostname:e.hostname)+e.id+"/"+t,f=JSON.stringify(n),h={Accept:"application/json","Content-Type":"application/json",Authorization:"Basic "+m},y=4e4,"withCredentials"in d&&(d.withCredentials=!0),d.open("POST",p,!0)
for(var g in h)h.hasOwnProperty(g)&&h[g]&&"setRequestHeader"in d&&d.setRequestHeader(g,h[g])
"onreadystatechange"in d?d.onreadystatechange=c:"onload"in d&&"onerror"in d&&(d.onload=c,d.onerror=u),l=setTimeout(function(){"onload"in d?d.onload=Function.prototype:d.onreadystatechange=Function.prototype,d.abort(),d=null,u("Timeout after "+y+" milliseconds")},y),d.send(f)},e}.call(this),e=this.OpenPay,this.OpenPay.card=function(t){function r(){return r.__super__.constructor.apply(this,arguments)}return n(t,r),r.tokenName="card",r.whitelistedAttrs=["card_number","holder_name","cvv2","expiration_month","expiration_year","address"],r.charge=function(t,n,a){return e.validate(t,"tarjeta"),e.formatData(t,r.whitelistedAttrs),e.send("charges",t,n,a)},r.create=function(t,n,a){var o="cards"
return void 0!==e.customerId&&""!==e.customerId&&(o="customers/"+e.customerId+"/cards"),e.validate(t,"tarjeta"),e.formatData(t,r.whitelistedAttrs),e.send(o,t,n,a)},r.validateCardNumber=function(e){return e=(e+"").replace(/\s+|-/g,""),/^\d+$/.test(e)&&e.length>=10&&e.length<=16&&r.luhnCheck(e)&&r.validateCardNumberLength(e)&&r.validateAcceptCardNumber(e)},r.validateCVC=function(t){return t=e.utils.trim(t),/^\d+$/.test(t)&&t.length>=3&&t.length<=4},r.validateExpiry=function(t,n){var r,a
