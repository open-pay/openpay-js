...
this.OpenPay=function(){function e(){}return e.version=1,e.sandboxMode=!1,e.hostname="https://api.openpay.mx/v1/",e.sandboxHostname="https://sandbox-api.openpay.mx/v1/",e.setSandboxMode=function(t){e.sandboxMode=t?!0:!1},e.getSandboxMode=function(){return e.sandboxMode},e.setId=function(t){e.id=t},e.setApiKey=function(t){e.key=t},e.log=function(e){"object"==typeof e&&"toString"in e&&(e=""+e),"undefined"!=typeof console&&"log"in console&&console.log(e)},e.validate=function(e,t){if(!e)throw t+" required"
