...
return n}
return e=o(e),t=i(e,"data-openpay-card"),n=s(t,"data-openpay-card"),a=i(e,"data-openpay-card-address"),void 0!==a&&a.length&&a.length>0&&(r=s(a,"data-openpay-card-address"),void 0!==r&&(n.address=r)),n},e.send=function(t,n,r,a){function o(e,t){var n=typeof e[t]
...
try{r=JSON.parse(n)}catch(o){e="Response error"}a({message:e,status:t,data:r,toString:function(){return this.message+" [status "+this.status+"]"}})}function c(){if(void 0!==d.readyState&&4==d.readyState||"undefined"!=typeof XDomainRequest)if(clearTimeout(l),d.status<200||d.status>=300)u("Request error",d.status,d.responseText)
else try{r({data:JSON.parse(d.responseText),status:200})}catch(e){u("Response error (Unknown final status)",d.status,"{}")}}var d=null,l=null,p="",f="",h={},y=0,m=""
...
m=i(e.key),p=e.sandboxMode?e.sandboxHostname:e.developMode?e.developHostname:e.hostname,p=p+e.id+"/"+t,f=JSON.stringify(n),h={Accept:"application/json","Content-Type":"application/json",Authorization:"Basic "+m},y=4e4,"withCredentials"in d&&(d.withCredentials=!0),d.open("POST",p,!0)
...
return r.create(i,n,a,o)},r.create=function(t,n,a,o){var i="cards"
